...
def pow_ss_asm(label, AVX=False, BIT64=True):
    ...
    """
    if BIT64:
        asm_code += "movss	dword [rsp - 4], xmm5\n"
    else:
        asm_code += "movss	dword [esp - 4], xmm5\n"
    ...
    """
    if BIT64:
        asm_code += "movss	xmm5, dword [rsp - 4]\n"
    else:
        asm_code += "movss	xmm5, dword [esp - 4]\n"
    ...
    """
    if BIT64:
        avx_code += "vmovss	dword [rsp - 4], xmm5\n"
    else:
        avx_code += "vmovss	dword [esp - 4], xmm5\n"
    ...
    """
    if BIT64:
        avx_code += "vmovss	xmm5, dword [rsp - 4]\n"
    else:
        avx_code += "vmovss	xmm5, dword [esp - 4]\n"
    avx_code += """
