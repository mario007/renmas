...
irender.options(asm=False, spectral=False, pixel_size=1.0, width=600, height=600, spp=1, threads=1)
irender.set_camera(type="perspective", eye=(-8, 5.5, 40), lookat=(1, 4, 0), distance=2400)
