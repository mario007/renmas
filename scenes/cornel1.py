...
## FLOOR
irender.add_shape(type="triangle", name="Floor1", material="white", P0=(0,0,0), P2=(55.28,0,0), P1=(0,0,55.92))
irender.add_shape(type="triangle", name="Floor2", material="white", P0=(55.28,0,0), P1=(0,0,55.92), P2=(55.28,0,55.92))

## BACK WALL
irender.add_shape(type="triangle", name="Back_wall1", material="white", P0=(0,0,55.92), P1=(0,54.88,55.92), P2=(55.28,54.88,55.92))
irender.add_shape(type="triangle", name="Back_wall2", material="white", P0=(0,0,55.92), P1=(55.28,54.88,55.92), P2=(55.28,0,55.92))

## RIGHT WALL
irender.add_shape(type="triangle", name="Right_wall1", material="green", P0=(0,0,0), P1=(0,54.88,0), P2=(0,0,55.92))
irender.add_shape(type="triangle", name="Right_wall2", material="green", P0=(0,54.88,0), P1=(0,54.88,55.92), P2=(0,0,55.92))

## LEFT WALL
irender.add_shape(type="triangle", name="Left_wall1", material="red", P0=(55.28,0,0), P1=(55.28,54.88,55.92), P2=(55.28,54.88,0))
irender.add_shape(type="triangle", name="Left_wall2", material="red", P0=(55.28,0,0), P1=(55.28,0,55.92), P2=(55.28,54.88,55.92))

#irender.add_shape(type="rectangle", name="Ceiling", material="white", P=(0,54.88,0), Edge_a=(0,0,55.92), Edge_b=(55.28,0,0), Normal=(0,-1,0))
## TOP
irender.add_shape(type="triangle", name="Top1", material="white", P0=(0,54.88,0), P2=(0,54.88,55.92), P1=(55.28,54.88,55.92))
irender.add_shape(type="triangle", name="Top2", material="white", P0=(0,54.88,0), P1=(55.28,54.88,0), P2=(55.28,54.88,55.92))

## gornji dio manje kocke
#irender.add_shape(type="triangle", name="Short1", material="white", P0=(0.474,0.165,0.225), P1=(0.426,0.165,0.065), P2=(0.316,0.165,0.272))
#irender.add_shape(type="triangle", name="Short2", material="white", P0=(0.266,0.165,0.114), P1=(0.316,0.165,0.272), P2=(0.426,0.165,0.065))
...
irender.add_shape(type="triangle", name="short_side11", material="white", P0=(13,0,6.5), P1=(8.2,0,22.5), P2=(13,16.5,6.5))
irender.add_shape(type="triangle", name="short_side12", material="white", P0=(8.2,0,22.5), P1=(8.2,16.5,22.5), P2=(13,16.5,6.5))

#irender.add_shape(type="triangle", name="Short5", material="white", P0=(0.316,0.0,0.272), P1=(0.316,0.165,0.272), P2=(0.474,0.165,0.225))
#irender.add_shape(type="triangle", name="Short6", material="white", P0=(0.474,0.165,0.225), P1=(0.316,0.0,0.272), P2=(0.474,0.0,0.225))

#irender.add_shape(type="triangle", name="Short7", material="white", P0=(0.474,0.0,0.225), P1=(0.474,0.165,0.225), P2=(0.426,0.165,0.065))
#irender.add_shape(type="triangle", name="Short8", material="white", P0=(0.426,0.165,0.065), P1=(0.426,0.0,0.065), P2=(0.474,0.0,0.225))

#irender.add_shape(type="triangle", name="Short9", material="white", P0=(0.426,0.0,0.065), P1=(0.426,0.165,0.065), P2=(0.266,0.165,0.114))
#irender.add_shape(type="triangle", name="Short10", material="white", P0=(0.266,0.165,0.114), P1=(0.266,0.0,0.114), P2=(0.426,0.0,0.065))
